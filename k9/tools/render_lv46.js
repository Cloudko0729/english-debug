...
const EXTRA_ZH = {
  ...
  cd: "光碟", "chinese new year": "農曆新年", light: "燈；光",
  "already": "已經", "cd player": "CD播放器", france: "法國", french: "法語；法國的", japan: "日本", kaohsiung: "高雄", leave: "離開", "mother's day": "母親節", "new year's day": "元旦", rest: "休息", taichung: "台中", tainan: "台南", taipei: "台北", "teacher's day": "教師節",
  arrive: "抵達", asia: "亞洲", australia: "澳洲", canada: "加拿大", "christmas eve": "平安夜", "double tenth day": "雙十節", "dragon-boat festival": "端午節", headache: "頭痛", "hong kong": "香港", japanese: "日語；日本的", ktv: "KTV", "lantern festival": "元宵節", london: "倫敦", "los angeles": "洛杉磯", mandarin: "國語；華語", "michael jackson": "麥可傑克森", "mid-autumn festival": "中秋節", mtv: "音樂電視台", "new york": "紐約", painting: "畫作；繪畫", paris: "巴黎", passport: "護照", relax: "放鬆", taiwanese: "台灣的；台語", tokyo: "東京", "valentine's day": "情人節", vcr: "錄放影機", worse: "更糟的",
...
// 字彙池用 wordLevel()（WORD_LEVELS + EXTRA_LEVELS 合併查詢），涵蓋 Codex 額外分級字，
// 修正原本只用 WORD_LEVELS 子集漏收 extra 字的落差（Lv.4/5/6 各少 30/150/309 字）。
...
if (require.main === module) {
  for (const level of LEVELS) {
    ...
    const canonicalCount = canonicalWordsFor(level.id).length;

...
// 涵蓋 curriculum.js 目前的全部主題（2026-07 ~ 2027-07）。
const THEME_ICON = {
  // 2026 上半的既有週次
  "旅行與時間": "✈️", "我的一天與社區": "🏘️", "校園社團與班級挑戰": "🏫",
  "週末露營與家庭小任務": "🏕️", "露營": "🏕️", "旅行": "✈️",
  // 8 月
  "夏日戶外與安全": "🏕️", "廚房與料理": "🍳",
  "7 月總複習": "🔁", "8 月上半總複習": "🔁", "新學期與課表": "🎒",
  // 9–10 月
  "商店與購物": "🛒", "城市與交通": "🚇", "中秋與家人": "🥮",
  "天氣與季節": "🌦️", "圖書館與閱讀": "📚", "朋友與情緒": "🙂",
  "運動與比賽": "⚽", "身體與健康": "💪", "醫院與健康": "🏥",
  // 11–12 月
  "食物與營養": "🥗", "動物與棲地": "🦉", "動物與自然": "🦉",
  "家事與幫忙": "🧹", "科技與3C": "💻", "科技與 3C": "💻",
  ...
  "春季複習週": "🔁", "清明家族與戶外": "🌿", "溝通與表達": "💬",
  "媒體與訊息": "📰", "比較與選擇": "⚖️", "世界與國家": "🌏",
  "國中教室英語": "🎓", "考試與作業英語": "✏️", "意見與理由": "🗣️",
  "畢業與轉銜複習": "🎓", "國一先修(上)": "📘", "國一先修(下)": "📗",
  "難字總複習A": "🔠", "難字總複習B": "🔡",
};
